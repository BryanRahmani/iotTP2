        ...
        stream.on('event', function(data) {
                ...
                evenement.save().then(function(res, err) {
                    io.emit('event', res);
                        ...
                        particle.getVariable({ deviceId: '290029001047363333343437' , name: 'analogValue', auth: token }).then(function(dataResistor) {
                          //console.log('Device variable retrieved successfully:', data);
                            dataResistor.body.device_id = '290029001047363333343437';
